# <table cellspacing="0" cellpadding="0" border="0"><tr><td><img src="img/icon.png" alt="icon" width="100"/></td><td valign="center">Sops Secrets Construct Library</td></tr></table>
