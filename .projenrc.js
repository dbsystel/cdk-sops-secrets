...
additionalActions = [
  ...
  {
    name: 'Prepare assets',
    run: 'mkdir -p assets && mkdir cdk-sops-secrets/assets && zip assets/cdk-sops-lambda.zip ./dist-goreleaser/cdk-sops-secrets_linux_amd64/cdk-sops-lambda && cp assets/cdk-sops-lambda.zip cdk-sops-secrets/assets/cdk-sops-lambda.zip',
  },
];
