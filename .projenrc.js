...
additionalActions = [
  ...
  },
  {
    ...
    run: 'mkdir -p assets && mv ./dist-goreleaser/cdk-sops-lambda.zip ./assets/cdk-sops-lambda.zip && touch -t 202002020000 assets/cdk-sops-lambda.zip && md5 assets/cdk-sops-lambda.zip',
  },
];
